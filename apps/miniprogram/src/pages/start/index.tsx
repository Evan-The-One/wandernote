...
export default function Start(){
  ...
  return <View className={`page start-page step-${step}`}>
    <Brand/>
    {step===1&&<><View className="start-copy"><Text className="title">不用查攻略{`\n`}告诉我去哪儿</Text><View className="muted">行程直接安排好</View></View><View className="travel-illustration compact"><View className="travel-sun"/><View className="travel-mountain"/><View className="travel-road"/><View className="travel-pin"/></View></>}
