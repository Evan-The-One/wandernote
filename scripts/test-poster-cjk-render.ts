...
import {renderPosterPages,POSTER_RENDER_VERSION} from "../src/server/posters/render";
...
const output=travelPosterSpecSchema.parse({
  kind:"travel_poster",version:"oneclick_travel_advice_icons_v9",tripId:"00000000-0000-4000-8000-000000000001",tripVersion:1,aspectRatio:"3:4",width:1024,height:1536,
...
assert.equal(POSTER_RENDER_VERSION,"sharp_svg_outlined_cjk_v5");
