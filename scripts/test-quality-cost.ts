...
const hotelSafe=normalizeTripPlanForQuality(branded,{...base!,days:1,destination:{...base!.destination,city:"上海"}});assert.doesNotMatch(JSON.stringify(hotelSafe),/香格里拉/);assert.match(JSON.stringify(hotelSafe),/静安寺附近酒店/);
