...
export const timelinePosterV2SpecSchema = z.object({
  kind: z.literal("travel_poster"), version: z.enum(["shaoxing_timeline_v2","readable_visuals_v3"]), tripId: z.string().uuid(), tripVersion: z.number().int().positive(), aspectRatio: z.literal("3:4"),
