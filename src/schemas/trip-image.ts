...
export const timelinePosterV2SpecSchema = z.object({
  ...
  preTripAdvice: z.object({ transport:z.string().max(72),accommodation:z.string().max(72),clothing:z.string().max(72),photoSpots:z.string().max(72),food:z.string().max(72),timing:z.string().max(72) }).optional(),
