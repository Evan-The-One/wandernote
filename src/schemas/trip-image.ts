...
export const timelinePosterV2SpecSchema = z.object({
  kind: z.literal("travel_poster"), version: z.enum(["shaoxing_timeline_v2","readable_visuals_v3","readable_visuals_v3_1","realistic_generic_visuals_v4"]), tripId: z.string().uuid(), tripVersion: z.number().int().positive(), aspectRatio: z.literal("3:4"),
