...
const styleGuides: Record<TripInput["travelStyle"], string> = {
  ...
  lazy: "懒人旅行：比慢旅行进一步降低活动数量、步行和换乘；尽量10点后出发，优先酒店附近或同一片区，明确加入酒店/咖啡馆/午休等休息。",
...
【活动密度与路线】
5. attraction、shopping、entertainment算主要游玩活动。fast_paced普通完整游玩日必须4至6个主要活动；slow为2至4个；lazy为2至3个。餐饮、咖啡、酒店休息不计入此数量，但总时间仍须合理。陪父母、带孩子、全家出行或用户指定较晚出发时，安全与作息优先，可降低密度并在dayTips解释。
