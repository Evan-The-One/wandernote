...
export default function TripPage() {
  ...
  return <main className="page-shell flex min-h-[70vh] items-center justify-center"><div className="text-center">{missing ? <><h1 className="text-2xl font-bold">还没有保存的旅行计划</h1><Link href="/#plan" className="mt-6 inline-block rounded-full bg-[#245b46] px-6 py-3 font-bold text-white">帮我安排这几天</Link></> : <div className="h-9 w-9 animate-spin rounded-full border-4 border-[#245b46]/20 border-t-[#245b46]" />}</div></main>;
}
