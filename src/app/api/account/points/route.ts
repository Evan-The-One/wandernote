...
const labels:Record<string,string>={signup_bonus:"新用户赠送",admin_grant:"管理员发放",poster_reserve:"海报生成预留",poster_consume:"生成旅行海报",poster_refund:"海报失败返还",poster_release:"海报失败返还",purchase:"购买点数",purchase_credit:"购买点数",purchase_refund:"购买退款",adjustment:"点数调整"};
